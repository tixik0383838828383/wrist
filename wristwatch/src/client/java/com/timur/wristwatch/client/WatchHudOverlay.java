 ...
 * появляется по центру экрана чуть ниже прицела, пока часы активны. Никакой матричной
 * геометрии/костей — чистый 2D HUD, поэтому не зависит ни от Figura, ни от модели персонажа.
 */
public final class WatchHudOverlay {
	...
	private static void render(DrawContext context, RenderTickCounter tickCounter) {
		...
		// Панель появляется по центру экрана, чуть ниже прицела, с небольшим сдвигом сверху
		// вниз по мере progress (эффект "выезжает"), не перекрывая ни прицел, ни хотбар внизу.
		int targetY = screenHeight / 2 + 24;
		int startY = targetY - 14;
